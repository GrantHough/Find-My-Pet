...
struct PostView: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            Toggle(isOn: $found) {Text ("Showing animals that have been" + "\(found ? " lost:" : " found:")")}
                .padding(.leading)
                .padding(.trailing)
            ...
            .frame(width: UIScreen.main.bounds.width - 20, height: UIScreen.main.bounds.height * 0.44)
